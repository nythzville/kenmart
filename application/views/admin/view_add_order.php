                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form id="customer-form" method="post" class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="password" name="passwordconf" id="passwordconf" required="required" class="form-control col-md-7 col-xs-12" >
                                            </div>
                                        </div>
