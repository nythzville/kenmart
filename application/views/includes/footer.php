...
?>
                ...
                <footer>
                    <div class="">
                        <p class="pull-right">! Online Ordering and Inventory <a></a>. |
    ...
    <!-- image cropping 
    <script src="<?php echo $the_url; ?>/js/cropping/cropper.min.js"></script>
    <script src="<?php echo $the_url; ?>/js/cropping/main.js"></script>
